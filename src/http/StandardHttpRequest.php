...
/**
 * Standard HTTP request adapter for classic PHP SAPIs (Apache, Nginx PHP-FPM, FrankenPHP).
 *
 * Reads and sanitizes PHP superglobals into a unified {@see Request}.
 * Prefer this name over the legacy {@see ApacheRequest} alias.
 */
