...
14. On deprecated `SwooleApiService`, `validatePosts` now throws — use `safeValidatePosts` for old return style
...
- [docs/improvements/](../../../docs/improvements/) — shared backlog (shipped)
