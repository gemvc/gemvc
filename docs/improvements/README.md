...
| **Unified `ApiService` (runtime)** | Phase 0–2 **done**; Phase 3 planned | Shared `ApiServiceSharedTrait` (auth, rate limit, `callController`). Dual bases remain until Phase 3. See [api-runtime-unification.md](api-runtime-unification.md) |
