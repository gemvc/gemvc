...
1. [`ai/INDEX.md`](ai/INDEX.md) — map + hard rules  
2. [`ai/CANONICAL.md`](ai/CANONICAL.md) — architecture, auth, CRUD, Do/Don’t  
...
- Philosophy (*why*): [`ARCHITECTURE.md`](ARCHITECTURE.md). Internals (*how*): [`guides/architecture.md`](guides/architecture.md)
...
Drivers: `apcu` | `redis` | `both` (dual check, not failover) | `none`. No auto Redis↔APCu fallback. Overrides: `requireRateLimitApcu()` / `requireRateLimitRedis()` / `requireRateLimitBoth()`. Guides: [`guides/api.md`](guides/api.md) · [`guides/security.md`](guides/security.md).
...
| Need | Open |
|------|------|
| Rate limit (global / service) | [`guides/api.md`](guides/api.md) · [`guides/security.md`](guides/security.md) |
| Packages | [`guides/ecosystem.md`](guides/ecosystem.md) |
| Table / ViewTable | [`guides/database.md`](guides/database.md) |
| Atomic money / `forUpdate` | [`guides/model.md#atomic-money-transfers-pessimistic-lock`](guides/model.md#atomic-money-transfers-pessimistic-lock) |
| OpenSwoole isolation / pool / FAQ | [`guides/openswoole.md`](guides/openswoole.md) |
| FrankenPHP classic / worker | [`guides/frankenphp.md`](guides/frankenphp.md) |
| Family trust / ServiceCall | [`guides/security.md`](guides/security.md#family-trust-phase-2a) · [`guides/http-client.md`](guides/http-client.md#servicecall-phase-2b) |
| API / Controller / Model | [`guides/api.md`](guides/api.md), [`guides/controller.md`](guides/controller.md), [`guides/model.md`](guides/model.md) |
| Install | [`guides/installation.md`](guides/installation.md) |
| Human + AI docs index | [`README.md`](README.md) |
